...
export const feature20 = {
  ...
  caption: 'Sind Sie bereit, mit uns zu arbeiten?',
  actionBtn: { children: 'Kontakt aufnehmen', href: SECTION_PATH},
  secondaryBtn: { children: 'Explore Blocks', href: SECTION_PATH },
  features: [
    {
      icon: 'tabler-accessible',
      title: 'Höchster Komfort',
      content: 'Passen Sie Ihr Klima Ihrem Lebensstil an'
    },
    {
      icon: 'tabler-brand-google',
      title: 'Höchste Qualität',
      content: 'Genießen Sie die Vorzüge verlässlicher Lösungen'
    },
    {
      icon: 'tabler-stack-2',
      title: 'Energieeffizienz',
      content: 'Senken Sie Ihre Energiekosten'
    },
    {
      icon: 'tabler-rocket',
      title: 'Intelligente Regelung',
      content: 'Regeln Sie Ihr Klima von jedem Ort aus'
    },
    {
      icon: 'tabler-help',
      title: 'Flexibilität in der Klimasteuerung',
      content: 'Ermöglichen Sie eine präzise Regulierung der Temperatur in einzelnen Zonen oder Räumen'
    },
    {
      icon: 'tabler-refresh',
      title: 'Breites Anwendungsspektrum',
      content: 'FCUs können sowohl in Kühl- als auch in Heizsystemen eingesetzt werden'
    }
  ]
};
